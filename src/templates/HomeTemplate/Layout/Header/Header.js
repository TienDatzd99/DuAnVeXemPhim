...
export default function Header() {
  ...
  const getClassName = ({ isActive }) => 
    isActive ? 'flex items-center -mb-0.5 border-b-2 px-4 border-transparent text-violet-600 border-violet-600 text-white' : 'flex items-center -mb-0.5 border-b-2 px-4 border-transparent text-white';
